...
from models import build_linear_model
...
def main():
    ...
    linear_model = build_linear_model(numerical_features, categorical_features)
    linear_model.fit(X_train, y_train)

    joblib.dump(linear_model, "../resources/models/linear_model.pkl")

    mae, mse, rmse = evaluate_model(linear_model, X_test, y_test)
    linear_metrics = {"MAE": mae, "MSE": mse, "RMSE": rmse}

    with open("../resources/stats/linear_reg/linear_metrics.json", "w") as f:
